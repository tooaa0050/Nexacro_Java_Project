(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            //-- Default Layout : this.divCalFromTo00
            obj = new Layout("default","",0,0,this.divCalFromTo00.form,function(p){});
            this.divCalFromTo00.form.addLayout(obj.name, obj);

            //-- Default Layout : this.divCalMM01
            obj = new Layout("default","",0,0,this.divCalMM01.form,function(p){});
            this.divCalMM01.form.addLayout(obj.name, obj);

            //-- Default Layout : this.divCalFromTo01
            obj = new Layout("default","",0,0,this.divCalFromTo01.form,function(p){});
            this.divCalFromTo01.form.addLayout(obj.name, obj);
            ...
            //-- Default Layout : this.divCalFromTo02
            obj = new Layout("default","",0,0,this.divCalFromTo02.form,function(p){});
            this.divCalFromTo02.form.addLayout(obj.name, obj);

            //-- Default Layout : this.divCalMM02
            obj = new Layout("default","",0,0,this.divCalMM02.form,function(p){});
            this.divCalMM02.form.addLayout(obj.name, obj);
