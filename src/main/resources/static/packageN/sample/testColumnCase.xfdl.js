(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"DEPT_ID\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"MEMBER_COUNT\" type=\"INT\" size=\"256\"/></ColumnInfo>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"141\"/><Column size=\"176\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"DEPT_ID\"/><Cell col=\"1\" text=\"DEPT_NAME\"/><Cell col=\"2\" text=\"MEMBER_COUNT\"/></Band><Band id=\"body\"><Cell text=\"bind:DEPT_ID\"/><Cell col=\"1\" text=\"bind:DEPT_NAME\" edittype=\"normal\"/><Cell col=\"2\" text=\"bind:MEMBER_COUNT\" edittype=\"normal\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("testColumnCase.xfdl", function() {
        /**
        *  컨설팅 표준화 작업
        ...
        */
        this.fnSearch = function ()
        {
        	// 조회조건 설정
         	...
         	var strSvcId    = "search";
        	var strSvcUrl   = "select_datalist_map.do"; // "retrieve_datalist.do";
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("testColumnCase.xfdl");
