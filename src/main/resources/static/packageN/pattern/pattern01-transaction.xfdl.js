(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"postId\" type=\"int\" size=\"4\"/><Column id=\"hitCount\" type=\"int\" size=\"4\"/><Column id=\"communityId\" type=\"string\" size=\"32\"/><Column id=\"regDate\" type=\"datetime\" size=\"17\"/><Column id=\"title\" type=\"string\" size=\"32\"/><Column id=\"contents\" type=\"string\" size=\"32\"/></ColumnInfo>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"206\"/><Column size=\"373\"/><Column size=\"80\"/><Column size=\"48\"/></Columns><Rows><Row size=\"25\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"글 ID\"/><Cell col=\"1\" text=\"제목\"/><Cell col=\"2\" text=\"내용\"/><Cell col=\"3\" text=\"등록일자\"/><Cell col=\"4\" text=\"조회수\"/></Band><Band id=\"body\"><Cell text=\"bind:postId\"/><Cell col=\"1\" text=\"bind:title\" edittype=\"normal\"/><Cell col=\"2\" text=\"bind:contents\" edittype=\"normal\"/><Cell col=\"3\" text=\"bind:regDate\"/><Cell col=\"4\" text=\"bind:hitCount\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item0","divSearch.form.edtTitle","value","dsSearch","searchKeyword");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        */
        ...
        this.divSearch_btnSearchSingle_onclick = function(obj,e)
        {
        	// 조회조건 설정
         	//this.dsSearch.setColumn(0, "title"  , this.divSearch.form.edtTitle.value);

         	var strSvcId    = "search";
        	var strSvcUrl   = "select_data_single.do"; // "retrieve_datalist.do";
        ...
        this.fnSearch = function ()
        {
        	// 조회조건 설정
         	...
         	var strSvcId    = "search";
        	var strSvcUrl   = "select_datalist.do"; // "retrieve_datalist_map.do";
        	var inData      = "dsSearch=dsSearch";
        	var outData     = "dsList=output1";
        	var strArg      = "";
        	var callBackFnc = "fnCallback";
        ...
        */
        this.fnSave = function()
        {
        	...
        	var strSvcUrl   = "update_datalist_map.do";  // "update_datalist_map.do";
