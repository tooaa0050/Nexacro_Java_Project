...
import com.nexacro.uiadapter.jakarta.dao.jdbc.JdbcRowHandler;
 ...
 */
@Repository("largeDataJdbc")
public class LargeDataJdbc extends JdbcDaoSupport {
	...
	public void selectLargeData(NexacroFirstRowHandler firstRowHandler, String sendName, int firstRowCount) {
        ...
        String sql = "SELECT LARGE_ID, NAME, REG_DATE, STORY, STATUS FROM TB_LARGE";
